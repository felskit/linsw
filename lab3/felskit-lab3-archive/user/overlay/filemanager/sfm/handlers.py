...
HOME_DIR = os.path.expanduser('/files')
...
class HandleAction(object):
    ...
    def _chdir(self):
        ...
        if (os.path.samefile(path, ''.join([HOME_DIR, '/..']))):
            return {'exception': 'Cannot access parent directory'}
...
class FileListHandler(BaseHandler):
    ...
    def get(self):
        self.render('file_list.html', user= self.current_user)
