...
gpio10_thread = threading.Thread(target = gpio10_handler)
gpio22_thread = threading.Thread(target = gpio22_handler)
gpio27_thread = threading.Thread(target = gpio27_handler)
gpio_threads = [gpio10_thread, gpio22_thread, gpio27_thread]
